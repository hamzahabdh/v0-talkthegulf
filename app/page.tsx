  ...
  return (
    <main className="min-h-screen bg-background px-6 py-12 md:px-12 md:py-20">
      <div className="mx-auto max-w-xl">
        ...
        {/* Footer */}
        <footer className="-mx-6 mt-16 px-6 py-8 md:-mx-12 md:px-12" style={{ backgroundColor: "#132225" }}>
          <div className="mx-auto max-w-xl">
            <p className="text-xs" style={{ color: "#00f7ff" }}>Find and follow me here</p>
            <div className="mt-3 flex items-center gap-2 text-xs" style={{ color: "#00f7ff" }}>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:opacity-80 transition-opacity">
